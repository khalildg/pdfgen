...
<table>
  <tr>
    ...
    <p style="font-size:7.5px;font-family: malgun gothic;">SFR Business, marque du groupe SFR,<br> est à destination des entreprises</p></th>
    <th class="title"><p>Migration de l’offre data de Pack Business Entrepreneurs</p>
    <p>vers l’offre Accès Max</p>
    <p>(anciennement dénommées 9dsl, 9dsl+, SFR DSL, SFR DSL+)</p></th>
  </tr>
  <tr> 
  <td class="tdtitre"></td>
  <td class="tdtitre"></td>
...
<p style="font-size:10px">Nous vous rappelons que votre offre PBR intégral et intégral max incluent les services suivants : </p>
<table class="tableau">
         <tbody>
             <tr>
         ...
         <tbody>
             <tr>
                 ...
                 <td rowspan="4">
                     ...
                     <p class="text ">Ligne Nomade + Option numéro fixe sur mobile </p>
                     <p class="text ">Ligne Fax</p>
                     <p class="text ">Accès internet ADSL (pour l’intégral) et FOM (pour l’intégral Max) </p>
                 </td>
                 <td rowspan="4">
                     <p class="text">PBE</p>
     ...
     <p style="font-family: Arial; font-size : 12px;font-weight: bold;">
         Dans le cadre de la migration PBR vers PBE, votre accès DATA deviendra l’offre accès max sans impact tarifaire
         sur votre facturation
         globale.
     </p>
     <p style="font-family: Arial; font-size : 12px;">SFR et le Client ont signé un contrat référencé relatif à la fourniture du Service lien DATA (anciennement
         dénommé 9dsl, 9dsl+, SFR DSL, SFR
...
<p style="font-family: Arial; font-size : 12px;">Le présent Avenant a pour objet le réengagement sur 36 mois de chacun des Accès et/ou Lignes pour une nouvelle Période Minimale d’Engagement à compter de la date d’entrée en vigueur du présent Avenant. </p>
<table class="titre">
<tr>
<th>Conditions tarifaires</th>
</tr>
</table>
<p style="font-family: Arial; font-size : 12px;">Dans le cas de réengagement avec évolutions tarifaires, les Conditions Tarifaires du Contrat sont supprimées et
         remplacées par celles annexées
         au présent Avenant.</p>
     <p style="font-family: Arial; font-size : 12px;">Ces nouvelles Conditions Tarifaires seront applicables dans un délai de trente (30) jours suivant la date
...
<br>
<br>
<p style="font-size:6.5px;font-family:corbel">SFR - 16 rue du Général Alain de Boissieu 75015 PARIS- SA au capital de 3 423 265 598,40 euros - RCS Paris 343 059 564 - N° TVA FR 71 343 059 564 – Bon de Commande Ligne Business IP </p>
<br>
<br>
<table>
  <tr>
  ...
  <table class="temp">
         <tbody>
             <tr class="temp" style="width:50%">
                 ...
                 <th style="text-align: left;width:50%; font-size:9px;" class="temp" ><label>Pour le Client, signataire dûment habilité </label></th>
         ...
         <tbody>
             ...
             <tr class="temp">
               ...
               <tr class="temp">
               <td rowspan="5" class="temp">
                    <p><label style="font-size : 7.5px; font-family: Arial">Nom/Prénom :</label><input class="no-outline" type="text" value=" ${nomPrenom}"></p>
                    <p><label style="font-size : 7.5px; font-family: Arial">Fonction :</label><input type="text" class="no-outline" value=" ${fonction}"></p>
                     <p><label style="font-size : 7.5px; font-family: Arial">Téléphone :</label><input type="text" class="no-outline" value=" ${phone}"></p>
                 ...
                 <p><label style="font-size : 7.5px; font-family: Arial">Nom : </label></p>
                     ...
                     <p><label style="font-size : 7.5px; font-family: Arial">Faite à : </labe></p>
                     </<td>
                     <td rowspan="5" class="temp"><textarea style="height:100px;font-size: 7px;width:100px ;">Signature et Cachet commercial</textarea>
                     </td>
                     </tr>
